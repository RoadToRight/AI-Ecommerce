...
import { createProduct, deleteProducts, fetchAllProducts, fetchSearchProducts, SingleProductAPI } from "../controllers/productController.js";
import { authorizedRoles, isAuthenticated } from "../middlewares/auth.js";

const app = express.Router();

app.get("/products/all", fetchAllProducts)
app.post("/products/search", fetchSearchProducts)
