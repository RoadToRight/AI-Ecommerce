...
export const updateProductConfigFunction = (data) => {


    let UpdateFields = updateProduct[0].fields.map(field => ({
        ...field,
        placeholder: data[field.name] ?? ""   // assign value if exists
    }))

    updateProduct[0].fields = UpdateFields;
